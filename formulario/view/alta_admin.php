...
<title>MixaHarris - Formulario Altas Admin</title>
<body>
	<h1>Formularios Altas Admin</h1>
	<table>
		<form name='altasAdmin' action="../action/save_admin.php" method='post' accept-charset='utf-8'>
