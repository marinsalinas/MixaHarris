...
<body>
	...
	$cliente=array();
	$datosCliente = array("nombre","apellidos", "direccion","CP","email", "tel", "username", "pass", "cel", "ocupacion",
	...
	$sql = "INSERT INTO MixaHarris.clientes (idclientes, clientesNombre, clientesApellido, clientesDireccion, clientesCP, clientesEmail, clientesTelefono, clientesUsername, clientesPassword, ClientesCelular, clientesOcupacion, clientesSexo, clientesNacimiento)
